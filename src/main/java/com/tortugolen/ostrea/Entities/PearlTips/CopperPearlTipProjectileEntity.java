...
public class CopperPearlTipProjectileEntity extends ThrowableItemProjectile {
    float DAMAGE = 5F;
    float RECYCLE = 0.5F;

    public CopperPearlTipProjectileEntity(EntityType<? extends CopperPearlTipProjectileEntity> type, Level level) {
        super(type, level);
    }
    ...
    protected Item getDefaultItem() {
        return InitItems.COPPER_PEARL_TIP.get();
    }
