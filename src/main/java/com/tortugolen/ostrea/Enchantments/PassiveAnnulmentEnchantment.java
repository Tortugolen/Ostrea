...
public class PassiveAnnulmentEnchantment extends Enchantment {
    public PassiveAnnulmentEnchantment(Rarity pRarity, EnchantmentCategory pCategory, EquipmentSlot... pEquipmentSlots) {
