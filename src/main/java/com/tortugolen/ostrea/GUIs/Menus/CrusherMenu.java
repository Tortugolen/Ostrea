...
public class CrusherMenu extends AbstractContainerMenu {
    ...
    public CrusherMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(InitMenus.CRUSHER_MENU.get(), pContainerId);
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            ...
            this.addSlot(new SlotItemHandler(iItemHandler, 1, 110, 35) {
                @Override
    ...
    public int getScaledProgress() {
        ...
        return progress * 22 / maxProgress;
    }
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), pPlayer, InitBlocks.CRUSHER.get());
    }
