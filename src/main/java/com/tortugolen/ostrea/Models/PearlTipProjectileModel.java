...
public class PearlTipProjectileModel<T extends PearlTipProjectileEntity> extends EntityModel<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("ostrea", "pearl_tip_projectile"), "main");
	private final ModelPart main;

	public PearlTipProjectileModel(ModelPart root) {
