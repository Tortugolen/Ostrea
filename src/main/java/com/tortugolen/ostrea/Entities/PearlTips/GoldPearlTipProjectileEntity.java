...
public class GoldPearlTipProjectileEntity extends ThrowableItemProjectile {
    float DAMAGE = 4F;
    float RECYCLE = 0.25F;

    public GoldPearlTipProjectileEntity(EntityType<? extends GoldPearlTipProjectileEntity> type, Level level) {
        super(type, level);
    }
    ...
    protected Item getDefaultItem() {
        return InitItems.GOLD_PEARL_TIP.get();
    }
