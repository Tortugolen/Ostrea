...
public class GoldPearlTipProjectileModel<T extends GoldPearlTipProjectileEntity> extends EntityModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("ostrea", "gold_pearl_tip_projectile"), "main");
    private final ModelPart main;

    public GoldPearlTipProjectileModel(ModelPart root) {
