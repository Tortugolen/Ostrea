...
public class ImprovedAxolotlHelmetModel extends EntityModel<Player> {

	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Ostrea.MOD_ID, "improved_axolotl_helmet"), "main");
	public final ModelPart head;

	public ImprovedAxolotlHelmetModel(ModelPart root) {
