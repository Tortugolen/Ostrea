...
public class IronPearlTipProjectileModel<T extends IronPearlTipProjectileEntity> extends EntityModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("ostrea", "iron_pearl_tip_projectile"), "main");
    private final ModelPart main;

    public IronPearlTipProjectileModel(ModelPart root) {
