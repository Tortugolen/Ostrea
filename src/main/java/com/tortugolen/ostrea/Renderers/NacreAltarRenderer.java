...
public class NacreAltarRenderer implements BlockEntityRenderer<NacreAltarBlockEntity> {

    public NacreAltarRenderer(BlockEntityRendererProvider.Context pContext) {}

    @Override
    public void render(NacreAltarBlockEntity pBlockEntity, float partialTicks, PoseStack pPoseStack, MultiBufferSource pBuffer, int combinedLight, int combinedOverlay) {
