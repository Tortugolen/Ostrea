...
public class CopperPearlTipItem extends Item {
    public CopperPearlTipItem(Properties pProperties) {
        super(pProperties);
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pUsedHand) {
        ...
        if (pLevel instanceof ServerLevel serverLevel) {
            CopperPearlTipProjectileEntity pearlTipProjectile = new CopperPearlTipProjectileEntity(pPlayer, pLevel);
